...
Процедура ЗаполнитьНаборТестов(НаборТестов) Экспорт
	...
	НаборТестов.НачатьГруппу("Функции работы с формой кредитного калькулятора", Истина);
...
Процедура Тест_УказатьСрокКредитования() Экспорт
	...
	ЭтаФорма.СрокКредита = 300;
	ПараметрыТеста = Новый Структура("ТестФорма", ЭтаФорма);
	
	Утверждения.ПроверитьВыполнилось("Параметры.ТестФорма.ОбновитьПараметрыКалькулятора()", ПараметрыТеста);
	
	Утверждения.ПроверитьРавенство(ЭтаФорма.СрокКредита, 300);
...
Процедура Тест_УказатьСуммуКредита() Экспорт
	...
	ЭтаФорма.СуммаКредита = 1000000;

	ПараметрыТеста = Новый Структура("ТестФорма", ЭтаФорма);
	Утверждения.ПроверитьВыполнилось("Параметры.ТестФорма.ОбновитьПараметрыКалькулятора()", ПараметрыТеста);
	
	Утверждения.ПроверитьРавенство(ЭтаФорма.СуммаКредита, 1000000);
...
Процедура Тест_УказатьСтавкуКредитования() Экспорт
	...
	ЭтаФорма.СтавкаКредитования = 5.99;

	ПараметрыТеста = Новый Структура("ТестФорма", ЭтаФорма);
	Утверждения.ПроверитьВыполнилось("Параметры.ТестФорма.ОбновитьПараметрыКалькулятора()", ПараметрыТеста);
	
	Утверждения.ПроверитьРавенство(ЭтаФорма.СтавкаКредитования, 5.99);
